module Block
  struct Block
    getter persona_line : PersonaLine
    getter content : String
  
    def initialize(persona_line : PersonaLine, content : String)
      @persona_line = persona_line
      @content = content
    end
  end
  
  def blocks_from_text(text : String)
    blocks = [] of Block
    current_block_text = ""
    ...
    text.each_line do |line|
      if is_persona_line(line)
        ...
        current_persona_line = parse_persona_line(line)
      else
